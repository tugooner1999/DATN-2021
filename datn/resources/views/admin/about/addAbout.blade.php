                ...
                <div class="container-fluid">
                    <div class="row bg-title">
                        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                            <h4 class="page-title">Thêm danh Giới Thiệu </h4> </div>
                        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="active">Thêm danh Giới Thiệu</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-8 col-xs-12">
                            <div class="white-box">
                                ...
                                <form class="form-horizontal form-material" action="{{ route('admin.saveAbout') }}" method="POST" enctype="multipart/form-data" >
                                    @csrf
